...
val changelog = listOf(
    ChangelogEntry(
        ...
        changes = listOf(
            ...
            "VERIFY: 8 проверок безопасности VPN",
            "THREATS: база из 15+ известных стукачей",
            "LEARN: инструкции по исправлению для Hiddify, NekoBox, v2rayNG",
            "Глоссарий технических терминов",
            "Анимация расследования (радар)",
            "Privacy mode / Сетевой режим",
            "Автообновление с SHA-256 верификацией",
            "MCC/SIM анализ опасных разрешений",
