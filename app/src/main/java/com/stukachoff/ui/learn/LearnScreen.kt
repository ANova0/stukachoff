...
val learnContent = mapOf(
    ...
    "split_tunnel" to LearnContent(
        ...
        fixes = listOf(
            ClientFix("Hiddify",
                "Настройки → Маршрутизация → Mode: по приложению. " +
                "Выбери приложения которые идут через прокси (YouTube, Telegram и др.). " +
                "Российские приложения оставь без галочки — пойдут напрямую."),
            ClientFix("v2rayNG",
